...
#include "process.h"
	...
	#define __semaphore_export__ __public
#else
	#define __semaphore_export__ extern
#endif
...
__sempahore_export interrupt_stack_frame* semaphore_v(int sem_id, selector* ldt, selector* ss, dword* esp, interrupt_stack_frame* stack_frame);
